...
class SentimentModel:
    ...
    def predict(self, text: str) -> Dict[str, Any]:
        ...
        class_probs = {str(cls): float(prob) for cls, prob in zip(self.model.classes_, probabilities)}
    ...
    def predict_batch(self, texts: list) -> list:
        ...
        for i, text in enumerate(texts):
            results.append(
                {"text": text, "sentiment": predictions[i], "confidence": round(float(max(probabilities[i])), 4)}
            )
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "score_mapping": {"1-2 stars": "negative", "3 stars": "neutral", "4-5 stars": "positive"},
        }
